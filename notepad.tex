...
\] 
In this notation, one can then express (without bias correction) Adam optimizer \footnotemark{}\footnotetext{The update for AdamW (Adam with decoupled weight decay) is given by $\theta_{t+1} = \theta$} as:
\[
